...
public class RegistroRevista extends javax.swing.JFrame {
    ...
    public RegistroRevista() {
        initComponents();
        this.setLocationRelativeTo(null);
    }

    public RegistroRevista(ArrayList<RevistaPublicada> array, ArrayList<BoletinPublicado> array2) {
        initComponents();
        this.setLocationRelativeTo(null);
    ...
    private void registrarRevistaJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarRevistaJButtonActionPerformed
        ...
        if (!tituloRevistaJTextfield.getText().isEmpty()) {
            ...
            stringDelDialogo += " - El Título no puede estar vacio.\n";
        ...
        if (!autorRevistaJTextField.getText().isEmpty()
            ...
            stringDelDialogo += " - El nombre del autor, no puede contener números.\n";
            hayCamposVacios = true;
        ...
        if (!editorialRevistaJTextField.getText().isEmpty()) {
            ...
            stringDelDialogo += " - La Editorial no puede estar vacía.\n";
            hayCamposVacios = true;
        ...
        if (!correoRevistaJTextField.getText().isEmpty()
            ...
            stringDelDialogo += " - Formato de correo no válido. Solo punto (.), guión (-) y guión bajo (_).\n";
            hayCamposVacios = true;
        }
        ...
        if (!numeroDePaginasJTextField.getText().isEmpty()
            ...
            stringDelDialogo += " - El número de páginas solo admite número y no puede estar vacío.\n";
            hayCamposVacios = true;
        }
        ...
        if (!precioRevistaJTextField.getText().isEmpty()
            ...
            stringDelDialogo += " - El precio solo admite números, su formato es 0.0 y no puede estar vacio ni ser negativo.\n";
            hayCamposVacios = true;
        }
        ...
        if (hayCamposVacios) {
            ...
            PantallaPrincipal nuevaPantallaPrincipal = new PantallaPrincipal(nuevaRevistasPublicas, nuevosBoletinesPublicos);
